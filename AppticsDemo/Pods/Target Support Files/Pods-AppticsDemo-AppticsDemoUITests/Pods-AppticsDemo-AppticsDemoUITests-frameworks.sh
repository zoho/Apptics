...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/Apptics-SDK/Core/Apptics.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/Apptics-SDK/CrashKit/AppticsCrashKit.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/Apptics-SDK/EventTracker/AppticsEventTracker.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/Apptics-SDK/JWT/JWT.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/Apptics-SDK/KSCrash/KSCrash.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/Apptics-SDK/ScreenTracker/AppticsScreenTracker.framework"
