...
extension UIImage{
    func imageWithBlur() -> UIImage? {
        let weight = [0.1216216216, 0.1944445946, 0.1216216216, 0.0540540541, 0.0162162162]
        ...
        for y in 1..<4 {
            horizBlurredImage?.draw(in: CGRect(x: 0, y: CGFloat(y), width: size.width, height: size.height), blendMode: .hardLight, alpha: CGFloat(weight[y]))
