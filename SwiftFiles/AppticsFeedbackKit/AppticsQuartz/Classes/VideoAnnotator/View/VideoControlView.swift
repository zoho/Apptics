...
struct AnnotationEditorViewColors{
    static let controlViewButtonColor = QuartzRGBColor.annotationControlViewButtionColor
    static let thumbnailContainerViewBGColor = QuartzRGBColor.thumbanilContainerBGColor
    static let shapeBlockViewBGColor = QuartzRGBColor.shapeBlockViewBGColor
    static let shapeIndicatorViewBGColor = QuartzRGBColor.shapeIndicatorViewBGColor
    static let audioRowViewBGColor = QuartzRGBColor.audioRowViewBGColor
    static let recordedVideoAudioTrackBGColor = QuartzRGBColor.recordedVideoAudioTrackBGColor
    static let recordedAudioBlockViewBG = QuartzRGBColor.recordedAudioBlockViewBG
    static let handlerViewCenterLineColor = QuartzRGBColor.handlerViewCenterLineColor
    static let selectionBorderColor = QuartzRGBColor.selectionBorderColor
    static let toolBarIconsColor = QuartzRGBColor.toolBarIconsColor
    static let toolBarTextColor = QuartzRGBColor.toolBarTextColor
    static let bottomToolBarColor = QuartzRGBColor.bottomToolBarColor
    static let shapeColorPickerBGColor = QuartzRGBColor.shapeColorPickerBGColor
    static let borderStyleCellContentViewBGColor = QuartzRGBColor.borderStyleCellContentViewBGColor
    static let borderStyleCellContentSelectionBGColor = QuartzRGBColor.borderStyleCellContentSelectionBGColor
    static let strokeWidthLabelTxtColor = QuartzRGBColor.strokeWidthLabelTxtColor
    static let recordAudioIconColor = QuartzRGBColor.recordAudioIconColor
    static let textMaskingViewBGColor = QuartzRGBColor.textMaskingViewBGColor
}

struct RecordingStoppinViewColors{
    static let screenRecordingStoppingViewBGColor = QuartzRGBColor.screenRecordingStoppingViewBGColor
    static let screenRecordingStoppingViewBorderColor = QuartzRGBColor.screenRecordingStoppingViewBorderColor
    static let screenRecordingStoppingViewTextColor = QuartzRGBColor.screenRecordingStoppingViewTextColor
}

struct LoadingViewColors{
    static let loadingViewBg = QuartzRGBColor.loaderBoxColor
    static let circularLoaderUnfilledColor = QuartzRGBColor.loadingCircleUnfilledColor
    static let submittingTextColor = QuartzRGBColor.submittingTextColor
}
