...
@objc public class FloatingBottomView:UIViewController,UIGestureRecognizerDelegate{
    ...
    //MARK: set color for the text in view
    
    func setTextColorInViews(){
        floatview.cancelBttn.setTitleColor(FeedbackTheme.sharedInstance.textColor, for: .normal)
        floatview.snapBttn.setTitleColor(FeedbackTheme.sharedInstance.textColor, for: .normal)
        floatview.screenshotBttn.setTitleColor(FeedbackTheme.sharedInstance.textColor, for: .normal)
        floatview.cancelImage.setTitleColor(FeedbackTheme.sharedInstance.textColor, for: .normal)
        floatview.snapImage.setTitleColor(FeedbackTheme.sharedInstance.textColor, for: .normal)
        floatview.screenshotsImage.setTitleColor(FeedbackTheme.sharedInstance.textColor, for: .normal)
