...
class FloatingView: UIView {
    ...
    func commoninit(){
        ...
        cancelImage.setTitle(FontIconText.cancelIcon, for: .normal)
        cancelImage.titleLabel?.font = UIFont(name: appticsFontName, size: appFontsize)
        snapImage.setTitle(FontIconText.snapIcon, for: .normal)
        snapImage.titleLabel?.font = UIFont(name: appticsFontName, size: appFontsize)
        screenshotsImage.setTitle(FontIconText.screenshotsIcon, for: .normal)
        screenshotsImage.titleLabel?.font = UIFont(name: appticsFontName, size: appFontsize)
    }
}
