...
- (void)insertTempHeatmapDataWithSessionID:(NSNumber *)sessionID
                                      data:(NSData *)data;
- (void)getTempHeatmapDataForSessionID:(NSNumber *)sessionID
                         markAsSyncing:(BOOL)markAsSyncing
                     completionHandler:(void (^)(NSMutableArray *heatmaps))completion;
- (void)getAllSessionStartTimesFromTempHeatmap:(void (^)(NSMutableArray<NSNumber *> *sessions))completion;
- (void)updateTempHeatmapSyncingStatus:(BOOL)status forSessionID:(NSNumber *)sessionID;
- (void)deleteTempHeatmapDataForSessionID:(NSNumber *)sessionID;
