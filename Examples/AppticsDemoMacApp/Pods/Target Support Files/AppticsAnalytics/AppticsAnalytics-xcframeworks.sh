...
install_xcframework "${PODS_ROOT}/AppticsAnalytics/Apptics.xcframework" "AppticsAnalytics/Apptics" "framework" "macos-x86_64"
install_xcframework "${PODS_ROOT}/AppticsAnalytics/AppticsCrashKit.xcframework" "AppticsAnalytics/CrashKit" "framework" "macos-x86_64"
install_xcframework "${PODS_ROOT}/AppticsAnalytics/AppticsEventTracker.xcframework" "AppticsAnalytics/EventTracker" "framework" "macos-x86_64"
install_xcframework "${PODS_ROOT}/AppticsAnalytics/JWT.xcframework" "AppticsAnalytics/JWT" "framework" "macos-x86_64"
install_xcframework "${PODS_ROOT}/AppticsAnalytics/KSCrash.xcframework" "AppticsAnalytics/KSCrash" "framework" "macos-x86_64"
install_xcframework "${PODS_ROOT}/AppticsAnalytics/AppticsScreenTracker.xcframework" "AppticsAnalytics/ScreenTracker" "framework" "macos-x86_64"
