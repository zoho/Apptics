...
@objc public class AppticsExtensionManager:NSObject{
    ...
    @objc public class func trackEvent(groupname:String,eventName:String,property:[String : Any]){
    ...
    @objc public class func trackEventWithProperty(groupname:String,eventName:String){
