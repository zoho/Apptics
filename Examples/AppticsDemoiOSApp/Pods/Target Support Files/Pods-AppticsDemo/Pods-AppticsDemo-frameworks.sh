...
if [[ "$CONFIGURATION" == "AppStore" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/Apptics-SDK-iOS14.5/Apptics_SDK.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Apptics-Swift-Extension/Apptics_Swift.framework"
