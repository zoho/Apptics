...
variant_for_slice()
{
  ...
  "Apptics.xcframework/tvos-arm64")
    echo ""
    ;;
  "Apptics.xcframework/macos-x86_64")
    echo ""
    ;;
  ...
  "AppticsCrashKit.xcframework/watchos-arm64_32_armv7k")
    echo ""
    ;;
  "AppticsCrashKit.xcframework/macos-x86_64")
    echo ""
    ;;
  ...
  "AppticsEventTracker.xcframework/tvos-arm64_x86_64-simulator")
    echo "simulator"
    ;;
  "AppticsEventTracker.xcframework/macos-x86_64")
    echo ""
    ;;
  ...
  "KSCrash.xcframework/ios-arm64_i386_x86_64-simulator")
    echo "simulator"
    ;;
  "KSCrash.xcframework/macos-x86_64")
    echo ""
    ;;
  ...
  "AppticsScreenTracker.xcframework/ios-arm64_armv7")
    echo ""
    ;;
  "AppticsScreenTracker.xcframework/macos-x86_64")
    echo ""
    ;;
...
install_xcframework "${PODS_ROOT}/AppticsAnalytics/Apptics.xcframework" "AppticsAnalytics/Apptics" "framework" "ios-arm64_armv7" "ios-arm64_i386_x86_64-simulator" "ios-arm64_x86_64-maccatalyst"
install_xcframework "${PODS_ROOT}/AppticsAnalytics/AppticsCrashKit.xcframework" "AppticsAnalytics/CrashKit" "framework" "ios-arm64_i386_x86_64-simulator" "ios-arm64_armv7" "ios-arm64_x86_64-maccatalyst"
install_xcframework "${PODS_ROOT}/AppticsAnalytics/AppticsEventTracker.xcframework" "AppticsAnalytics/EventTracker" "framework" "ios-arm64_armv7" "ios-arm64_i386_x86_64-simulator" "ios-arm64_x86_64-maccatalyst"
install_xcframework "${PODS_ROOT}/AppticsAnalytics/JWT.xcframework" "AppticsAnalytics/JWT" "framework" "ios-arm64_i386_x86_64-simulator" "ios-arm64_x86_64-maccatalyst" "ios-arm64_armv7"
install_xcframework "${PODS_ROOT}/AppticsAnalytics/KSCrash.xcframework" "AppticsAnalytics/KSCrash" "framework" "ios-arm64_x86_64-maccatalyst" "ios-arm64_i386_x86_64-simulator" "ios-arm64_armv7"
install_xcframework "${PODS_ROOT}/AppticsAnalytics/AppticsScreenTracker.xcframework" "AppticsAnalytics/ScreenTracker" "framework" "ios-arm64_armv7" "ios-arm64_x86_64-maccatalyst" "ios-arm64_i386_x86_64-simulator"
