...
install_xcframework "${PODS_ROOT}/AppticsRemoteConfig/AppticsRemoteConfig.xcframework" "AppticsRemoteConfig/RemoteConfig" "framework" "tvos-arm64" "tvos-arm64_x86_64-simulator"
