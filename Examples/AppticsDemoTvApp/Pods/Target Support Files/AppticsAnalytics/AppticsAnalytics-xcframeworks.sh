...
install_xcframework "${PODS_ROOT}/AppticsAnalytics/Apptics.xcframework" "AppticsAnalytics/Apptics" "framework" "tvos-arm64" "tvos-arm64_x86_64-simulator"
install_xcframework "${PODS_ROOT}/AppticsAnalytics/AppticsCrashKit.xcframework" "AppticsAnalytics/CrashKit" "framework" "tvos-arm64" "tvos-arm64_x86_64-simulator"
install_xcframework "${PODS_ROOT}/AppticsAnalytics/AppticsEventTracker.xcframework" "AppticsAnalytics/EventTracker" "framework" "tvos-arm64_x86_64-simulator" "tvos-arm64"
install_xcframework "${PODS_ROOT}/AppticsAnalytics/JWT.xcframework" "AppticsAnalytics/JWT" "framework" "tvos-arm64_x86_64-simulator" "tvos-arm64"
install_xcframework "${PODS_ROOT}/AppticsAnalytics/KSCrash.xcframework" "AppticsAnalytics/KSCrash" "framework" "tvos-arm64_x86_64-simulator" "tvos-arm64"
install_xcframework "${PODS_ROOT}/AppticsAnalytics/AppticsScreenTracker.xcframework" "AppticsAnalytics/ScreenTracker" "framework" "tvos-arm64" "tvos-arm64_x86_64-simulator"
