...
install_xcframework "${PODS_ROOT}/AppticsAnalytics/Apptics/Apptics.xcframework" "AppticsAnalytics/Apptics" "framework" "tvos-arm64" "tvos-arm64_x86_64-simulator"
install_xcframework "${PODS_ROOT}/AppticsAnalytics/Apptics/AppticsCrashKit.xcframework" "AppticsAnalytics/CrashKit" "framework" "tvos-arm64" "tvos-arm64_x86_64-simulator"
install_xcframework "${PODS_ROOT}/AppticsAnalytics/Apptics/AppticsEventTracker.xcframework" "AppticsAnalytics/EventTracker" "framework" "tvos-arm64" "tvos-arm64_x86_64-simulator"
install_xcframework "${PODS_ROOT}/AppticsAnalytics/Apptics/JWT.xcframework" "AppticsAnalytics/JWT" "framework" "tvos-arm64" "tvos-arm64_x86_64-simulator"
install_xcframework "${PODS_ROOT}/AppticsAnalytics/Apptics/KSCrash.xcframework" "AppticsAnalytics/KSCrash" "framework" "tvos-arm64" "tvos-arm64_x86_64-simulator"
install_xcframework "${PODS_ROOT}/AppticsAnalytics/Apptics/AppticsScreenTracker.xcframework" "AppticsAnalytics/ScreenTracker" "framework" "tvos-arm64" "tvos-arm64_x86_64-simulator"
