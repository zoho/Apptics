...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/Apptics-SDK-iOS/Apptics_SDK.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Apptics-Swift-iOS/Apptics_Swift.framework"
