...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/Apptics-SDK-watchOS/Apptics_SDK.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Apptics-Swift-watchOS/Apptics_Swift.framework"
